...
| `REQ-COMP-01` Compatible snapshot preserved; incompatible snapshot discarded/live-refetched | P0-IOS-05, P1-IOS-03/04, P6-API-01, P6-DAT-01                      | C, I, R           |
...
| 23  | [Settings](../../docs/ios-mockups/rendered/screens/settings.png)                            | US-P0-03, US-P1-03/04, US-P4-05/07     | P1-IOS-05, P4-API-08, P4-IOS-06              | Connection status, Disconnect, redacted diagnostics, and Mac-owned Telegram settings; Household and unsupported controls hidden | I, UI, P, S, A       |
...
- A deferred or unsupported screen remains in the visual inventory, but its affordance must be hidden or clearly unavailable in builds until its scope is implemented.
