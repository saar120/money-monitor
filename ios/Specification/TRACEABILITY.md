...
| 6 | [Activity](../../docs/ios-mockups/rendered/screens/activity.png) | US-P2-02, US-P2-05/06/08 | P2-API-03, P2-IOS-03, P2-DAT-01 | `GET /transactions`; opaque cursor, safe DTO | C, I, UI, P, A |
| 7 | [Search](../../docs/ios-mockups/rendered/screens/search.png) | US-P2-03/07/08 | P2-API-03, P2-IOS-05, P2-QA-02 | `GET /transactions?q=…`; cancellable; query excluded from diagnostics | C, U, UI, S, A |
| 8 | [Transaction detail](../../docs/ios-mockups/rendered/screens/transaction.png) | US-P2-04/08; US-P4-03 when writes ship | P2-API-04, P2-IOS-06; P4-API-03/P4-IOS-03 | `GET /transactions/:id`; unsupported note/recurring/options hidden; writes capability-scoped | C, I, UI, S, A |
| 9 | [Filters sheet](../../docs/ios-mockups/rendered/screens/filters.png) | US-P2-03/08 | P2-IOS-04, P2-DES-01/02 | Draft vs applied local state; accepted transaction query parameters | U, UI, A |
...
| Activity → filter/search → transaction detail → restore state | US-P2-02/03/04/07/08 | Phase 2 daily-use slice | C, U, UI, P, A |
