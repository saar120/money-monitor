...
| P3-DAT-01 | iOS data | Planned | Extend encrypted snapshot/repositories for Phase 3 DTOs with compatibility validation: retain a compatible snapshot; discard an incompatible snapshot and live-refetch. Period changes can fetch detail/history without corrupting the coherent base snapshot. |
