...
| Stable Mac pairing endpoint                 | Physical pairing and prior iOS cold-launch persistence passed; no-flash update is installed and awaits unlock, reboot, and remaining security QA |
