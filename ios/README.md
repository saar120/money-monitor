...
| Private Mac bridge                          | Loopback server and path-scoped Tailscale coordinator implemented; stable private route passed two packaged-app cold restarts with distinct random ports |
...
| Stable Mac pairing endpoint                 | Physical pairing and iOS app cold-launch persistence passed; real iPhone reboot, re-pair, revocation, LAN isolation, and final evidence scan remain      |
