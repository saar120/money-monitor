...
| Stable Mac pairing endpoint                 | Pairing, no-flash restoration, reboot persistence, and same-device token rotation passed; revocation and final security QA await          |
