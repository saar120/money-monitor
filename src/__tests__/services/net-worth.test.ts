...
import { insertAccount, insertLiability, insertAsset, insertHolding, insertBalanceHistory, insertAssetSnapshot } from '../helpers/fixtures.js';
...
const { generateDatePoints, getNetWorth } =
  await import('../../services/net-worth.js');
